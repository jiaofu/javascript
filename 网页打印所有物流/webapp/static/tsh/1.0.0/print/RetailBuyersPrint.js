var RetailBuyersPrint=(function(){
...
$(function(){
	...
	eventUnit.addEvent(btnPrint,'click',function(){UtilTool.addPrintOrder(1);	window.print();},false);
	...
	printOrder.initbyCouny(data,RetailBuyersPrint.initTable,RetailBuyersPrint.initTop,RetailBuyersPrint.initTail);
